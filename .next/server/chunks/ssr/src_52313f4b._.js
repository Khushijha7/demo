        ...
        const fetchTransactions = async ()=>{
            ...
            try {
                ...
                const transactionPromises = accounts.map(async (account)=>{
                    if (!firestore) return;
                    const transactionsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(firestore, `users/${user.uid}/accounts/${account.id}/transactions`);
                    let q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(transactionsRef);
                    if (options.orderBy && options.orderDirection) {
                        q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(q, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["orderBy"])(options.orderBy, options.orderDirection));
                    }
                    if (options.limit) {
                ...
                if (options.orderBy) {
                    allTransactions.sort((a, b)=>{
                        const dateA = a.transactionDate instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Timestamp"] ? a.transactionDate.toMillis() : new Date(a.transactionDate).getTime();
                        const dateB = b.transactionDate instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Timestamp"] ? b.transactionDate.toMillis() : new Date(b.transactionDate).getTime();
...
//# sourceMappingURL=src_52313f4b._.js.map